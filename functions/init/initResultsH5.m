...
% - Creates extendable datasets for wellhead time series and profile snapshots
    ...
    h5create(outFile, '/chemistry/ca_in_kg', [Inf], 'ChunkSize', [chunkT], 'Datatype','double');
    h5create(outFile, '/chemistry/ca_out_kg', [Inf], 'ChunkSize', [chunkT], 'Datatype','double');
    h5create(outFile, '/chemistry/ca_precip_kg', [Inf], 'ChunkSize', [chunkT], 'Datatype','double');
    h5create(outFile, '/chemistry/ca_fluid_delta_kg', [Inf], 'ChunkSize', [chunkT], 'Datatype','double');
    h5create(outFile, '/chemistry/ca_balance_residual_kg', [Inf], 'ChunkSize', [chunkT], 'Datatype','double');
    try
        ...
        h5writeatt(outFile, '/chemistry/ca_in_kg', 'units', 'kg');
        h5writeatt(outFile, '/chemistry/ca_out_kg', 'units', 'kg');
        h5writeatt(outFile, '/chemistry/ca_precip_kg', 'units', 'kg');
        h5writeatt(outFile, '/chemistry/ca_fluid_delta_kg', 'units', 'kg');
        h5writeatt(outFile, '/chemistry/ca_balance_residual_kg', 'units', 'kg');
    catch
    end
    ...
    try
        ...
        desc = [ ...
            ...
            "  /chemistry/tol1          : chemistry solver tol1 [-]" newline ...
            "  /chemistry/ca_in_kg      : Ca mass imported into chemistry domain over step [kg]" newline ...
            "  /chemistry/ca_out_kg     : Ca mass exported from chemistry domain over step [kg]" newline ...
            "  /chemistry/ca_precip_kg  : net Ca mass transferred to minerals over hydrodynamic step [kg]" newline ...
            "  /chemistry/ca_fluid_delta_kg : Ca mass accumulation in mobile fluid over step [kg]" newline ...
            "  /chemistry/ca_balance_residual_kg : Ca balance closure residual over step [kg]" newline newline ...
