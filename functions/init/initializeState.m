...
state = ensureField(state, 'db', '/usr/local/share/doc/iphreeqc/database/LLNL_mod.dat');
...
state.CaInKg = nan(1, state.nt_well);
state.CaOutKg = nan(1, state.nt_well);
state.CaPrecipKg = nan(1, state.nt_well);
state.CaFluidDeltaKg = nan(1, state.nt_well);
state.CaBalanceResidualKg = nan(1, state.nt_well);
state.stepIndex = 1;
state.tt = 0;
