...
# Case: Tonkin "Problem 3 / East Mesa 6-1" - 198.5 degC low-enthalpy production, no heat loss.
# Extracted from LT_no_heat_loss.json (boundaries, feedzone, time) and LT_mesh.json (geometry).

## Grid Parameters

n = 128 # Number of grid points (matches mesh NEL = 50)
...
H_q = 0 # heat conduction coefficient (0 = adiabatic; case is "no heat loss", reservoir_heat_flux = false)
